...
<body>
	<form name="mysubs" method="POST" action="Controller">
		<input type="hidden" name="command" value="getmysubs" /> <input
			type="submit" value="<fmt:message key="mysubscription" bundle="${LOCALE}" />">
	</form>
</body>
</html>