...
<body>
	<form name="allbooks" method="POST" action="Controller">
		<input type="hidden" name="command" value="getallbooks" /> <input
			type="submit" value="<fmt:message key="books" bundle="${LOCALE}" />"/>
	</form>
</body>
</html>